...
PLACEMENTS = [
    {
        ...
        "url": (
            ...
            "&cursor=1&ga_id=142218391.0851147978"
    ...
    },
    {
        ...
        "url": (
            ...
            "&language=th&pool_tophit_date=365"
            "&userId=null&pseudoId=null"
            "&cursor=1&ga_id=142448491.084651337978"
            "&is_use_live=true&verbose=debug&pool_latest_date=365"
            "&partner_id=AN9PjZR1wEol"
            "&limit=3"
            "&limit_seen_item=10"
...
SEEN_PLACEMENTS = [p for p in PLACEMENTS if p["name"] in ["sfv-p8"]]
FIRST_ORDER_PLACEMENTS = [p for p in PLACEMENTS if p["name"] in ["sfv-p7", "sfv-p8"]]
RANDOM_PLACEMENTS = [p for p in PLACEMENTS if p["name"] in ["sfv-p8"]]
