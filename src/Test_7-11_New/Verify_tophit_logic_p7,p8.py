...
PLACEMENTS = [
    {
        ...
        "url": (
            ...
            "&cursor=1&ga_id=103318391.0851147978"
    ...
    },
    {
        ...
        "url": (
            ...
            "&language=th&pool_tophit_date=365"
            "&userId=null&pseudoId=null"
            "&cursor=1&ga_id=102213391.0851337978"
            "&is_use_live=true&verbose=debug&pool_latest_date=365"
            "&partner_id=AN9PjZR1wEol"
            "&limit=3"
            "&limit_seen_item=1"
...
def run_check(placement: dict) -> dict:
    ...
    out_path = f"{art_dir}/tc_tophit_latest_logic.json"
...
def test_7_11_tophit_latest_logic_sfv_p8():
    """[7-11] sfv-p8: bucketize_tophit_sfv publish_date check"""
    _assert_result(run_check(PLACEMENTS[1]))


def test_7_11_tophit_latest_logic():
    """รันทั้ง p7 + p8 ในครั้งเดียว"""
    test_7_11_tophit_latest_logic_sfv_p7()
    test_7_11_tophit_latest_logic_sfv_p8()
