...
# Config — shared
# ============================================================
BASE_HOST = "http://ai-universal-service-new.preprod-gcp-ai-bn.int-ai-platform.gcp.dmp.true.th"
EXPECTED_MODEL_HOST = (
    "https://search-preprod-api-container-1014252161752.asia-southeast1.run.app/api/{{ver}}/text_search"
)
